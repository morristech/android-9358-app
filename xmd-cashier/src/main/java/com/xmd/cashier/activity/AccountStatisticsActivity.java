...
public class AccountStatisticsActivity extends BaseActivity {
    private String[] STATISTICS_FILTER_TIME = new String[]{"日", "周", "月", "累计", "自定义"};
    private Drawable[] STATISTICS_FILTER_ICON = new Drawable[]{null, null, null, null, ResourceUtils.getDrawable(R.drawable.selector_tab_indicator)};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        for (int i = 0; i < STATISTICS_FILTER_TIME.length; i++) {
            ...
            mPageAdapter.addFragment(AccountStatisticsDetailFragment.class.getName(), args);
        }
    ...
    public void onStatisticsSetting(View view) {
        UiNavigation.gotoAccountStatisticsSettingActivity(this);
    }
