...
public class StatisticsDetailFragment extends Fragment implements StatisticsDetailContract.View {
    ...
    public void setDataNormal(OnlineStatisticInfo online, OfflineStatisticInfo offline) {
        ...
        mSettleTotal.setText("￥" + Utils.moneyToStringEx(online.totalSettleAmount));
        mSettleWX.setText("￥" + Utils.moneyToStringEx(online.totalWx));
        mSettleAli.setText("￥" + Utils.moneyToStringEx(online.totalAli));
        mSettleUnion.setText("￥" + Utils.moneyToStringEx(online.totalUnion));

        mOtherTotal.setText("￥" + Utils.moneyToStringEx(offline.totalRecharge + offline.cashPos));
        mOtherWX.setText("￥" + Utils.moneyToStringEx(offline.wxMember));
        mOtherAli.setText("￥" + Utils.moneyToStringEx(offline.aliMember));
        mOtherUnion.setText("￥" + Utils.moneyToStringEx(offline.unionMember));
        mOtherCash.setText("￥" + Utils.moneyToStringEx(offline.cashMember + offline.cashPos));
        mOtherElse.setText("￥" + Utils.moneyToStringEx(offline.otherMember));

        mTotalAmount.setText("￥" + Utils.moneyToStringEx(online.totalAmount));
        mInternalDiscount.setText("-￥" + Utils.moneyToStringEx(online.totalDiscount));
        mBonusCommission.setText("-￥" + Utils.moneyToStringEx(online.internalCommission));
        mTotalFee.setText("-￥" + Utils.moneyToStringEx(online.totalSettleFee));
        mTotalRefund.setText("-￥" + Utils.moneyToStringEx(online.totalRefund));
        mGDSettle.setText("￥" + Utils.moneyToStringEx(online.totalSettleAmount));
        mFastPay.setText("￥" + Utils.moneyToStringEx(online.fastPay));
        mQRTech.setText("￥" + Utils.moneyToStringEx(online.qrTech));
        mQRClub.setText("￥" + Utils.moneyToStringEx(online.qrClub));
        mQRPos.setText("￥" + Utils.moneyToStringEx(online.qrPos));
        mMemberRecharge.setText("￥" + Utils.moneyToStringEx(online.recharge));
        mPaidOrder.setText("￥" + Utils.moneyToStringEx(online.paidOrder));
        mMarketing.setText("￥" + Utils.moneyToStringEx(online.marketing));
        mPaidCoupon.setText("￥" + Utils.moneyToStringEx(online.paidCoupon));
        mPaidServiceItem.setText("￥" + Utils.moneyToStringEx(online.paidServiceItem));
        mMall.setText("￥" + Utils.moneyToStringEx(online.mall));
        mItemCard.setText("￥" + Utils.moneyToStringEx(online.itemCard));
        mItemPackage.setText("￥" + Utils.moneyToStringEx(online.itemPackage));
        mPosSettle.setText("￥" + Utils.moneyToStringEx(online.totalUnion));
        mPosSettleUnion.setText("￥" + Utils.moneyToStringEx(online.totalUnion));
        mOtherAmount.setText("￥" + Utils.moneyToStringEx(offline.cashPos + offline.totalRecharge + offline.totalDiscount + offline.totalRefund));
        mOtherInternalDiscount.setText("-￥" + Utils.moneyToStringEx(offline.totalDiscount));
        mOtherInternalRefund.setText("-￥" + Utils.moneyToStringEx(offline.totalRefund));
        mOtherPos.setText("￥" + Utils.moneyToStringEx(offline.cashPos));
        mOtherPosCash.setText("￥" + Utils.moneyToStringEx(offline.cashPos));
        mOtherMemberRecharge.setText("￥" + Utils.moneyToStringEx(offline.totalRecharge));
        mOtherMemberRechargeWX.setText("￥" + Utils.moneyToStringEx(offline.wxMember));
        mOtherMemberRechargeAli.setText("￥" + Utils.moneyToStringEx(offline.aliMember));
        mOtherMemberRechargeUnion.setText("￥" + Utils.moneyToStringEx(offline.unionMember));
        mOtherMemberRechargeCash.setText("￥" + Utils.moneyToStringEx(offline.cashMember));
        mOtherMemberRechargeElse.setText("￥" + Utils.moneyToStringEx(offline.otherMember));
    }
