...
public class TradeManager {
    ...
    public void printMemberPay(boolean keep, Callback<?> callback) {
        ...
        mPos.printDivide();
        mPos.printRight("实收金额：" + Utils.moneyToStringEx(mTrade.memberRecordInfo.amount) + " 元", true);
    ...
    public void printOnlinePay(boolean keep, Callback<?> callback) {
        ...
        mPos.printDivide();
        mPos.printRight("实收金额：" + Utils.moneyToStringEx(mTrade.onlinePayInfo.payAmount) + " 元", true);
        mPos.printDivide();
    ...
    public void printPosPay(boolean keep, Callback<?> callback) {
        ...
        mPos.printDivide();
        mPos.printRight("实收金额：" + Utils.moneyToStringEx(mTrade.getPosMoney()) + " 元", true);
        mPos.printDivide();
