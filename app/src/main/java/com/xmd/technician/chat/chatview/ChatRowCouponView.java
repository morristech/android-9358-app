...
public class ChatRowCouponView extends BaseEaseChatView {
    ...
    public ChatRowCouponView(Context context, EMMessage message, int position, BaseAdapter adapter) {
    ...
    protected void onInflateView() {
        mInflater.inflate(mEMMessage.direct() == EMMessage.Direct.RECEIVE ?
                R.layout.chat_row_received_coupon : R.layout.chat_row_sent_coupon, this);
    }
    ...
    protected void onSetUpView() {
        ...
        if (mEMMessage.direct() == EMMessage.Direct.SEND) {
            ...
            mCouponTip.setText(String.format("%s领取了您的\"%s\"", mEMMessage.getStringAttribute(ChatConstant.KEY_NAME, ""), content));
        }
