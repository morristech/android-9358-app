...
public class NormalCouponListFragment extends BaseListFragment<ShareCouponBean> {
    ...
    public static NormalCouponListFragment getInstance() {
        return new NormalCouponListFragment();
    }
    ...
    protected void dispatchRequest() {
        MsgDispatcher.dispatchMessage(MsgDef.MSG_DEF_GET_CARD_LIST_DETAIL, Constant.COUPON_TYPE);
    }
    ...
    private void handleCouponList(ShareCouponResult couponListResult) {
        if (couponListResult.statusCode == 200 && couponListResult.respData != null) {
