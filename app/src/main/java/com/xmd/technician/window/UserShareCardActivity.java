 ...
 */
//public class UserShareCardActivity {
//}
 ...
 */
public class UserShareCardActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        if(Utils.isNotEmpty(codeUrl)){
            Glide.with(UserShareCardActivity.this).load(codeUrl).error(ResourceUtils.getDrawable(R.drawable.icon22)).into(mUserShareCode);
        }else {
