...
//    public static final String SERVER_HOST = "http://spa.93wifi.com";
    ...
    public static final String URL_COMMENT_ORDER_REDPK_COUNT = BASE_URL + "/v1/profile/tech/notice";
    ...
    public static final String URL_DELETE_ALBUM = BASE_URL + "/v1/profile/album/delete_a";
    public static final String URL_UPLOAD_ALBUM = BASE_URL + "/v1/profile/tech/album/base64/upload_a";
