...
public class CustomAlertDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public Builder setNeutralButton(String neutralText, View.OnClickListener neutralClickListener) {
        ...
        public CustomAlertDialog build() {
            ...
            if (Utils.isNotEmpty(mNeutralText)) {
                mBtnNeutral.setText(mNeutralText);
                mBtnNeutral.setOnClickListener(v -> {
                    if (mNeutralClickListener != null) {
                        mNeutralClickListener.onClick(v);
                    }
                    dialog.dismiss();
                });
            } else {
