...
public class CircularBeadImageView extends ImageView {
    ...
    public CircularBeadImageView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.CircularBeadImageView);

        mBorderRadius = a.getDimensionPixelSize(
                R.styleable.CircularBeadImageView_border_radius, (int) TypedValue
                        .applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                                BODER_RADIUS_DEFAULT, getResources()
                                        .getDisplayMetrics()));// 默认为10dp
        type = a.getInt(R.styleable.CircularBeadImageView_type, TYPE_CIRCLE);// 默认为Circle
