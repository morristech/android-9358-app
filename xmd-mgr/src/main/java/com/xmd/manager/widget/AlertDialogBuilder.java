...
public class AlertDialogBuilder {
    ...
    public AlertDialogBuilder setNeutralButton(String neutralText, View.OnClickListener onClickListener) {
        mBuilder.setNeutralButton(neutralText, onClickListener);
        return this;
    }
