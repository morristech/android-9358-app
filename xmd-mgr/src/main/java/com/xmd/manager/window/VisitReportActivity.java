...
public class VisitReportActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setRightVisible(true, ResourceUtils.getString(R.string.right_btn_visit_detail), new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(VisitReportActivity.this, VisitReportDetailActivity.class);
        ...
        if (Utils.isNotEmpty(title)) {
            ...
            setTitle(ResourceUtils.getString(R.string.statistics_fragment_statistics_visit));
        }
    ...
    private void initView() {
      ...
      //  initStartDateTime = DateUtil.getDesignatedDate(DateUtil.MONTH);
        ...
        mStatisticsView.init(this, isItemCanClick);
        ...
        MsgDispatcher.dispatchMessage(MsgDef.MSG_DEF_GET_VISIT_REPORT, params);
    }
    ...
    private void handlerVisitResult(LineChartDataResult result) {
        if (result.statusCode == 200) {
            ...
            mStatisticsView.setTitles(ResourceUtils.getString(R.string.statistics_fragment_statistics_visit), String.valueOf(mTotalData), "日期",
                    title);
