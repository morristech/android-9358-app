...
public class TechCommissionDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<CommissionTechInfo> mData = new ArrayList<>();
    ...
    public interface CallBack {
        ...
        void onItemClick(CommissionTechInfo info);
    }
    ...
    public TechCommissionDetailAdapter(Context context) {
    ...
    public void setData(List<CommissionTechInfo> data) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof FooterViewHolder) {
            ...
            CommissionTechInfo info = mData.get(position);
